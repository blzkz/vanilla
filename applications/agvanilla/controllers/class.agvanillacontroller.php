...
/**
 * AgVanilla Controller for new applications.
 * 
 * Repace 'AgVanilla' with your app's short name wherever you see it.
 *
 * @package AgVanilla
 */
 ...
 * @package AgVanilla
 */
class AgVanillaController extends Gdn_Controller {
