...
class SkeletonHooks implements Gdn_IPlugin {
   ...
   public function Setup() {
      ...
      include(PATH_APPLICATIONS . DS . 'agvanilla' . DS . 'settings' . DS . 'structure.php');

      // Stores a value in the config to indicate it has previously been installed.
      // You can use if(C('AgVanilla.Setup', FALSE)) to test whether to repeat part of your setup.
      SaveToConfig('AgVanilla.Setup', TRUE);
   }
