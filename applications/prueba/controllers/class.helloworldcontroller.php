...
/**
 * HelloWorld Controller for new applications.
 *
 * Repace 'HelloWorld' with your app's short name wherever you see it.
 *
 * @package HelloWorld
 */
 ...
 * @package HelloWorld
 */
class HelloWorldController extends Gdn_Controller {
